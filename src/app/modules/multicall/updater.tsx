...
export function activeListeningKeys(
  allListeners: AppState['multicallBridge']['callListeners'],
  chainId?: number
...
export function outdatedListeningKeys(
  callResults: AppState['multicallBridge']['callResults'],
...
export default function Updater(): null {
  ...
  const state = useSelector<AppState, AppState['multicallBridge']>((s) => s.multicallBridge);
